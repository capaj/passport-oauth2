    ...
    describe('issuing authorization request that redirects to service provider', function() {
      ...
      describe('with prompt', function() {
        ...
        it('should be redirected', function() {
          expect(url).to.equal(
            'https://www.example.com/oauth2/authorize?prompt=mobile&response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&client_id=ABC123&client_secret=secret'
          )
        })
      }) // with prompt
      ...
      describe('with scope and prompt', function() {
        ...
        it('should be redirected', function() {
          expect(url).to.equal(
            'https://www.example.com/oauth2/authorize?prompt=mobile&response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&scope=email&client_id=ABC123&client_secret=secret'
          )
        })
