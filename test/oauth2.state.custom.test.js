  ...
  describe('with custom state store that accepts meta argument', function() {
    ...
    CustomStore.prototype.store = function(req, meta, cb) {
      ...
      if (meta.clientID !== 'ABC123') {
        return callback(new Error('incorrect meta.clientID argument'))
      }
    ...
    describe('issuing authorization request', function() {
      ...
      describe('that redirects to service provider', function() {
        ...
        it('should be redirected', function() {
          expect(url).to.equal(
            'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&state=foos7473&client_id=ABC123&client_secret=secret'
          )
        })
