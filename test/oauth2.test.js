...
describe('OAuth2Strategy', function() {
  describe('constructed', function() {
    describe('with normal options', function() {
      ...
      it('should be named centrify-oauth2', function() {
        expect(strategy.name).to.equal('centrify-oauth2')
      })
    }) // with normal options
  ...
  describe('issuing authorization request', function() {
    describe('that redirects to service provider without redirect URI', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to service provider with redirect URI', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to service provider with redirect URI and scope', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&scope=email&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to service provider with scope option as array', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&scope=permission_1%20permission_2&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to service provider with scope option as array using non-standard separator', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&scope=permission_1%2Cpermission_2&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to service provider with state option', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&state=foo123&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to service provider with redirect URI option', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback%2Falt1&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to service provider with relative redirect URI option', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback%2Falt2&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to authorization server using authorization endpoint that has query parameters with scope option', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?foo=bar&response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&scope=email&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to authorization server using authorization endpoint that has query parameters including scope with scope option', function() {
      var strategy = new OAuth2Strategy(
        {
          authorizationURL:
            'https://www.example.com/oauth2/authorize?foo=bar&scope=baz',
          tokenURL: 'https://www.example.com/oauth2/token',
          clientID: 'ABC123',
          clientSecret: 'secret',
          callbackURL: 'https://www.example.net/auth/example/callback'
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?foo=bar&scope=email&response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&client_id=ABC123&client_secret=secret'
        )
      })
    ...
    describe('that redirects to authorization server using authorization endpoint that has query parameters including state with state option', function() {
      ...
      it('should be redirected', function() {
        expect(url).to.equal(
          'https://www.example.com/oauth2/authorize?foo=bar&state=foo123&response_type=code&redirect_uri=https%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&client_id=ABC123&client_secret=secret'
        )
      })
  ...
  describe('using a relative redirect URI', function() {
    describe('issuing authorization request', function() {
      ...
      describe('that redirects to service provider from insecure connection', function() {
        ...
        it('should be redirected', function() {
          expect(url).to.equal(
            'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=http%3A%2F%2Fwww.example.net%2Fauth%2Fexample%2Fcallback&client_id=ABC123&client_secret=secret'
          )
        })
      ...
      describe('from behind a secure proxy', function() {
        ...
        describe('that is not trusted by app and sets x-forwarded-proto and x-forwarded-host', function() {
          ...
          it('should be redirected', function() {
            expect(url).to.equal(
              'https://www.example.com/oauth2/authorize?response_type=code&redirect_uri=http%3A%2F%2Fserver.internal%2Fauth%2Fexample%2Fcallback&client_id=ABC123&client_secret=secret'
            )
          })
